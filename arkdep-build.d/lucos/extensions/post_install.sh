...
aur_packages=('yay-bin' 'waydroid-helper' 'dolphin-megasync-bin' 'megasync-bin' 'ttf-jetbrains-mono' 'ttf-nerd-fonts-symbols' 'usb-dirty-pages-udev' 'wayfire' 'wf-shell' 'wcm' 'cosmic-session-git')
